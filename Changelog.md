...
- Delete button in detail view of the frontend. The grid view shows nicer preview images but lacked a way to delete images. This is now possible via the delete button in the detail view.