...
This document describes the API and data layout of a robust, industrial-grade database for **files (images, audio, video, and other binary data)**. The database stores files directly as separate files in folders in the filesystem, and related metadata in SQLite.
